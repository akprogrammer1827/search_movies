...
class _SearchResultState extends State<SearchResult> {
  ...
  Future<List<DataModel>> _getAllData() async {
    var url = Uri.parse("https://api.themoviedb.org/3/search/movie?api_key=b9a825a82ebe362e74f0a59439b3b6de&query=${widget.searchText}&page=1&include_adult=false");
                    ...
                    child: Row(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network("https://image.tmdb.org/t/p/w500/${s.data[i].poster_path}" ??"",height: 200,),
                        ),
                        SizedBox(width: 10,),
                        Flexible(
                          child: Column(
